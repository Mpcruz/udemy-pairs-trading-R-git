...
# AUS-CAN Chart
plot(as.zoo(aus),main="AUS-CAN Pair",xlab="",ylab="")
par(new=T)
plot(as.zoo(can),col="blue",xaxt="n",yaxt="n",xlab="",ylab="")
axis(side=4)
legend("topleft",legend=c("aus","can"),col=c("black","blue"),lty=1,cex=0.75)
par(new=F)
...
# CAN-RSA Chart
plot(as.zoo(can),main="CAN-RSA Pair",xlab="",ylab="")
par(new=T)
plot(as.zoo(rsa),col="blue",xaxt="n",yaxt="n",xlab="",ylab="")
axis(side=4)
legend("topleft",legend=c("can","rsa"),col=c("black","blue"),lty=1,cex=0.75)
par(new=F)
...
# AUS-RSA Chart
plot(as.zoo(aus),main="AUS-RSA Pair",xlab="",ylab="")
par(new=T)
plot(as.zoo(rsa),col="blue",xaxt="n",yaxt="n",xlab="",ylab="")
axis(side=4)
legend("topleft",legend=c("aus","rsa"),col=c("black","blue"),lty=1,cex=0.75)
par(new=F)
...
# GER-FRA Chart
plot(as.zoo(ger),main="GER-FRA Pair",xlab="",ylab="")
par(new=T)
plot(as.zoo(fra),col="green",xaxt="n",yaxt="n",xlab="",ylab="")
axis(side=4)
legend("topleft",legend=c("ger","fra"),col=c("black","green"),lty=1,cex=0.75)
par(new=F)
...
# NED-FRA Chart
plot(as.zoo(ned),main="NED-FRA Pair",xlab="",ylab="")
par(new=T)
plot(as.zoo(fra),col="green",xaxt="n",yaxt="n",xlab="",ylab="")
axis(side=4)
legend("topleft",legend=c("ned","fra"),col=c("black","green"),lty=1,cex=0.75)
par(new=F)
...
# GER-NED Chart
plot(as.zoo(ger),main="GER-NED Pair",xlab="",ylab="")
par(new=T)
plot(as.zoo(ned),col="green",xaxt="n",yaxt="n",xlab="",ylab="")
axis(side=4)
legend("topleft",legend=c("ger","ned"),col=c("black","green"),lty=1,cex=0.75)
par(new=F)
...
intjt1 <- ca.jo(int1,type="trace",ecdet="none",K=2,spec="longrun")
summary(intjt1)
...
intjt2 <- ca.jo(int2,type="trace",ecdet="none",K=2,spec="longrun")
summary(intjt2)
...
rlmint1 <- roll_lm(y=aus,x=can,intercept=F,width=63)
...
rlmint2 <- roll_lm(y=can,x=rsa,intercept=F,width=63)
...
intsig2 <- Lag(ifelse(Lag(rintz2)>(-2)&rintz2<(-2),-2,
                      ifelse(Lag(rintz2)<(-1)&rintz2>(-1),-1,
                             ifelse(Lag(rintz2)<2&rintz2>2,2,
                                    ifelse(Lag(rintz2)>1&rintz2<1,1,0)))))
intsig2[is.na(intsig2)] <- 0

# CAN-RSA Trading Strategy Positions
intpos2 <- ifelse(intsig2>2,1,0)
for(i in 1:length(rintz2)){intpos2[i] <- ifelse(intsig2[i]==-2,1,
                                                ifelse(intsig2[i]==-1,0,
                                                       ifelse(intsig2[i]==2,-1,
                                                              ifelse(intsig2[i]==1,0,intpos2[i-1]))))}
...
rlmint4 <- roll_lm(y=ger,x=fra,intercept=F,width=63)
...
intsig4 <- Lag(ifelse(Lag(rintz4)>(-2)&rintz4<(-2),-2,
                      ifelse(Lag(rintz4)<(-1)&rintz4>(-1),-1,
                             ifelse(Lag(rintz4)<2&rintz4>2,2,
                                    ifelse(Lag(rintz4)>1&rintz4<1,1,0)))))
intsig4[is.na(intsig4)] <- 0

# GER-FRA Trading Strategy Positions
intpos4 <- ifelse(intsig4>2,1,0)
for(i in 1:length(rintz4)){intpos4[i] <- ifelse(intsig4[i]==-2,1,
                                                ifelse(intsig4[i]==-1,0,
                                                       ifelse(intsig4[i]==2,-1,
                                                              ifelse(intsig4[i]==1,0,intpos4[i-1]))))}
...
rlmint5 <- roll_lm(y=ned,x=fra,intercept=F,width=63)
...
intsig5 <- Lag(ifelse(Lag(rintz5)>(-2)&rintz5<(-2),-2,
                      ifelse(Lag(rintz5)<(-1)&rintz5>(-1),-1,
                             ifelse(Lag(rintz5)<2&rintz5>2,2,
                                    ifelse(Lag(rintz5)>1&rintz5<1,1,0)))))
intsig5[is.na(intsig5)] <- 0

# NED-FRA Trading Strategy Positions
intpos5 <- ifelse(intsig5>2,1,0)
for(i in 1:length(rintz5)){intpos5[i] <- ifelse(intsig5[i]==-2,1,
                                                ifelse(intsig5[i]==-1,0,
                                                       ifelse(intsig5[i]==2,-1,
                                                              ifelse(intsig5[i]==1,0,intpos5[i-1]))))}
...
intret2c <- ifelse((intsig2==-2|intsig2==-1|intsig2==2|intsig2==1)&intpos2!=Lag(intpos2),(intspret2*intpos2)-0.001,intspret2*intpos2)
...
intret4c <- ifelse((intsig4==-2|intsig4==-1|intsig4==2|intsig4==1)&intpos4!=Lag(intpos4),(intspret4*intpos4)-0.001,intspret4*intpos4)
...
intret5c <- ifelse((intsig5==-2|intsig5==-1|intsig5==2|intsig5==1)&intpos5!=Lag(intpos5),(intspret5*intpos5)-0.001,intspret5*intpos5)
